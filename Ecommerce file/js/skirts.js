class skirts extends HTMLElement {
    connectedCallback() {
        this.innerHTML = `
        <!DOCTYPE html>
<html lang="en">
    ...
    <div>
        <div class="row">
            <div class="card" style="width: 175px; margin:30px;">
                ...
                <div class="card-body">
                    <h5 class="card-title">Cream skirts</h5>
            ...
            <div class="card" style="width: 175px; margin:30px;">
            <img class="card-img-top" src="images/f12.webp" alt="image of team member">
            <div class="card-body">
                <h5 class="card-title">Brown skirts</h5>
                <p style="text-align: center;">$15</p>
                <p class="card-text">Lorem ipsum dolor sit amet consectetur adipisicing elit. Ipsa impedit maiores, nam aliquam reprehenderit magni veritatis.</p>
                <button type="button" class="btn btn-dark" style="width: 100%; margin:0px 0px;"><i class="fa-solid fa-cart-shopping"></i><br>add to cart</button>
            </div>
...
window.customElements.define('all-skirts', skirts)